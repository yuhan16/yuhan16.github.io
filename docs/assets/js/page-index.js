function create_page_index_icon_list(curr_page, total_pages, pageurl, base){
    /*
    ...
    */
    ...
    var pager_div = document.getElementById("page-index-icon-col");
    var mylist = document.createElement("ul");
    mylist.setAttribute("id", "page-index-icon-list");      // no "page-index-icon-list" class defined, for id purpose 
    ...
    function createIcon(flag, url, content){
        var mylist = document.getElementById("page-index-icon-list");
        ...
        if (flag == 1){
            mydiv.className = "page-index-icon selected";
        }
        else{
            mydiv.className = "page-index-icon unselected";
        }
        a.appendChild(mydiv);
    }
